              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: (){
                      ...
                      // print("Price AED name: ${_PriceAED.text}");
                      // print("Product image: ${selectedImages}");
                      // print("dropdown Brands: ${dropdownBrands.split(" ")[0]}");
                      // print("dropdown Category: ${dropdownCategory.split(" ")[0]}");
...
//-------------------------
 ...
 // import 'package:http/http.dart as http;
   ...
   place_ad_upload(name,category,brand,baseurl,description,amount,email,password) async {

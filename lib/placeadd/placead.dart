...
//
// const List<String> Tlist = <String>['Select Category', 'Select brand'];
...
//   List<dynamic> categoryList = [{"name":'Select Category'}];
//   List<dynamic> brandsList = [{"name":"Select Category"}];
//   final picker = ImagePicker();
//   dynamic dropdownBrands = "Select Category";
//   dynamic dropdownCategory = "Select category";
//
...
//     print("placead.dart, fetch_Categories(), category : ${categoryList}");
...
//         print("placead.dart, BrandDropdown(), brandsList.map : ${category}");

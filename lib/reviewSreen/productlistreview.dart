...
import 'package:umonda/repositories/refund_request_repository.dart';
...
class ForRevieworder extends StatefulWidget {
  int id;
...
class _OrderDetailsState extends State<ForRevieworder> {
                          ...
                          child: _orderedItemList.length == 0 && _orderItemsInit
                            ...
                            child: Center(
                              child: CircularProgressIndicator(
                                valueColor: AlwaysStoppedAnimation<Color>(MyTheme.font_grey),
                              ),
                            ),
                          )))
                    ])),
  ...
  buildOrderedProductItemsCard(index) {
    return Container(
      child: Padding(
        ...
        child: InkWell(
          onTap: (){
            print("qwertyuiopoiuytrewqwertyu");
            print(_orderedItemList[index].product_name,);
            print(_orderedItemList[index].product_id,);

            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return
                // widget.identifier == 'auction'
                //   ? AuctionProductsDetails(id: widget.id)
                //   :
              ProductDetails(id: _orderedItemList[index].product_id,);
            }));
                        ...
                        onTap: () {
                          ...
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) {
                                return ProductReviews(id: _orderedItemList[index].product_id,);
                              })).then((value) {
                            onPopped(value);
                          });

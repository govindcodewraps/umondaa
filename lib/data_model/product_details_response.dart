...
class DetailedProduct {
  DetailedProduct({
    ...
    this.wholesale,
    this.minoffer,
    this.min_offer_price,
    this.category_id,
    this.dismantling_status,
    this.dismantling_fees,
    this.brand_id,
  });
  ...
  int min_offer_price;
  String category_id;
  int dismantling_status;
  var dismantling_fees;
  int brand_id;
  ...
  factory DetailedProduct.fromJson(Map<String, dynamic> json) => DetailedProduct(
    ...
    min_offer_price: json["min_offer_price"],
    category_id: json["category_id"],
    dismantling_status: json["dismantling_status"],
    dismantling_fees: json["dismantling_fees"],
...
/*class DetailedProduct {
  DetailedProduct({
    ...
    this.brand,
    this.wholesale,
    this.minoffer, // Added this field
  });
  ...
  factory DetailedProduct.fromJson(Map<String, dynamic> json) => DetailedProduct(
    ...
    wholesale: List<Wholesale>.from(
        json["wholesale"].map((x) => Wholesale.fromJson(x))),
    minoffer: json["minoffer"], // Added this field
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "brand": brand.toJson(),
    "wholesale": List<dynamic>.from(wholesale.map((x) => x.toJson())),
    "minoffer": minoffer, // Added this field
  };
}*/

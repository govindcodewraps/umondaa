...
import 'package:umonda/screens/seller_details.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:umonda/ui_elements/product_card.dart';
import 'package:umonda/ui_elements/shop_square_card.dart';
import 'package:umonda/ui_elements/brand_square_card.dart';
...
import 'package:umonda/repositories/shop_repository.dart';
...
import 'package:umonda/repositories/search_repository.dart';
...
class _TopBrandsState extends State<TopBrands> {
              ...
              child: TypeAheadField(
                ...
                itemBuilder: (context, suggestion) {
                  ...
                  if(suggestion.type != "search"){
                    subtitle = "${suggestion.type_string} ${AppLocalizations.of(context).found_all_lower}";
                  }
                  return ListTile(
                    dense: true,
  ...
  buildProductScrollableList() {
    if (_isProductInitial && _productList.length == 0) {
      ...
      return Center(child: Text( AppLocalizations.of(context).no_product_is_available));
    } else {
  ...
  buildBrandScrollableList() {
    if (_isBrandInitial && _topbrandList.length == 0) {
      ...
      return Center(child: Text(AppLocalizations.of(context).no_brand_is_available));
    } else {
      return Container(); // should never be happening
    }
  }
  ...
  buildShopScrollableList() {
    if (_isShopInitial && _shopList.length == 0) {
      ...
      return Center(child: Text(AppLocalizations.of(context).no_shop_is_available));
    } else {
      return Container(); // should never be happening
    }
  }

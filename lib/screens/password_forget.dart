...
class _PasswordForgetState extends State<PasswordForget> {
  ...
  onPressSendCode() async {
    ...
    if (_send_code_by == 'email' && email == "") {
      ...
      ToastComponent.showDialog(AppLocalizations.of(context).enter_phone_number, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          _send_code_by == "email" ? AppLocalizations.of(context).email_ucf : AppLocalizations.of(context).phone_ucf,
                          style: TextStyle(
                            ...
                            children: [
                              ...
                              otp_addon_installed.$
                                  ? GestureDetector(
                                      ...
                                      child: Text(
                                        AppLocalizations.of(context).or_send_code_via_phone_number,
                                        style: TextStyle(
                                            color: MyTheme.accent_color,

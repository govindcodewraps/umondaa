...
class _WalletState extends State<Wallet> {
  ...
  onPressProceed(){
    ...
    if(amount_String == ""){
      ToastComponent.showDialog( AppLocalizations.of(context).amount_cannot_be_empty, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  buildRechargeList() {
    if (_rechargeListInit && _rechargeList.length == 0) {
      ...
      return Center(child: Text( AppLocalizations.of(context).no_recharges_yet));
    } else {
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                fillColor: MyTheme.light_grey,
                                  filled: true,
                                  hintText:  AppLocalizations.of(context).enter_amount_ucf,
                                  hintStyle: TextStyle(
                                      fontSize: 12.0,

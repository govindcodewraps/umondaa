...
import 'package:umonda/custom/style.dart';
import 'package:umonda/custom/toast_component.dart';
import 'package:umonda/data_model/followed_sellers_response.dart';
...
Future  fetchShopData() async {
 ...
 return fetchShopData();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(LangText(context).local.followed_sellers_ucf,style: MyStyle.appBarStyle,),backgroundColor: MyTheme.white,

...
class StripeScreenWalletRecharge extends StatefulWidget {
  double amount;
  String payment_type;
  ...
  @override
  _StripeScreenWalletRechargeState createState() => _StripeScreenWalletRechargeState();
}

class _StripeScreenWalletRechargeState extends State<StripeScreenWalletRecharge> {
...
//   }
  ...
  stripe() {
    ...
    // "https://webcluestechnology.com/demo/erp/umonda/api/v2/stripe?payment_type=cart_payment&order_id=444&amount=1200&user_id=198";
        "${AppConfig.BASE_URL}/stripe?payment_type=wallet_payment&order_id=${_combined_order_id}&amount=${widget.amount}&user_id=${user_id.$}";

    var allurl ="${AppConfig.BASE_URL}/stripe?payment_type=wallet_payment&order_id=${_combined_order_id}&amount=${widget.amount}&user_id=${user_id.$}";
